...
procedure TfrmWhileLoop.btnRepeatUntilClick(Sender: TObject);
var
   intBaseNumber, intSquareNumber : Integer;
begin
   intBaseNumber := 1;
   ...
   lstResult.Items.Add('Square numbers 1 to 10 with a REPEAT/UNTIL-Loop');
   lstResult.Items.Add('');
